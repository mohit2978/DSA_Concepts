...
Here dp[i] means we have found LIS from 0 to i-1 now we want LIS of i!!
...
```
 ...
 both approaches are very important O(n^2) and O(nlgn)
...
### Approach 1: Left to Right (L to R)

here dp[i] means find LIS 0 to i we know LDS of 0 to  i-1
...
### Approach 2: Right to Left (R to L)

here dp[i] means we know from i+1 to n calculate for i to n!!
...
Similarly we have two approaches for LIS
...
we know from o to i-1 now calculate dp[i]
...
```
 ...
 ![alt text](<006 LIS_231124_134844(6).jpg>) ![alt text](<006 LIS_231124_134844(7).jpg>) 
...
```
 ...
 ![alt text](<006 LIS_231124_134844(12).jpg>) ![alt text](<006 LIS_231124_134844(13).jpg>) ![alt text](<006 LIS_231124_134844(14).jpg>) ![alt text](<006 LIS_231124_134844(15).jpg>)
